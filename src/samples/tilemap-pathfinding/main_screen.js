...
import { UtilsPathfinder } from '../../lib/utils_pathfinder/utils_pathfinder';
// ---------------------------------------------------------------------------------------
...
class MainScreen extends Screen {
  ...
  movePlayer(endX, endY) {
    ...
    let path = UtilsPathfinder.solve(collisionLayer.getGrid(), collisionLayer.getColumns(), [startX, startY], [endX, endY]);
    if (path) {
