...
class AdaptiveToneMappingPass extends Pass {
	...
	constructor( adaptive, resolution ) {
		...
		this.copyUniforms = UniformsUT.clone( copyShader.uniforms );
		...
		this.materialLuminance = new ShaderMaterial( {
			...
			uniforms: UniformsUT.clone( LuminosityShader.uniforms ),
		...
		this.materialAdaptiveLum = new ShaderMaterial( {
			...
			uniforms: UniformsUT.clone( this.adaptLuminanceShader.uniforms ),
		...
		this.materialToneMap = new ShaderMaterial( {
			...
			uniforms: UniformsUT.clone( ToneMapShader.uniforms ),
