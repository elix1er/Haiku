...
class InPlace{
  ...
  static MAT4_MULTIPLY_BY_QUAT(a :mat4, x:number, y:number, z:number, w:number){
  ...
  static QUAT_MULTIPLY_BY_VEC3(q:vec4, v:vec3, o = UT.VEC3_CREATE(0,0,0)):vec3
  {
    // Extract the vector part of the quaternion
    const u = UT.VEC3_CREATE(q[0], q[1], q[2]);
